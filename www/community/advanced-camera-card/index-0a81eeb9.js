import{_ as e,n as a,t as i,a as t,dr as r,x as s,dt as o,e3 as n,e4 as d,e5 as l,e6 as c,dB as h,r as g,b as m,dF as u,dM as v,e7 as C,e8 as p,e9 as w,ea as M,eb as I,dH as y,dw as _,dV as f,ec as b,dA as A,dm as j,ed as D,s as T,dx as x,dy as $,a5 as E,l as k,dC as L}from"./card-74d9012e.js";import"./image-player-aa266da7.js";import{i as N}from"./media-dimensions-container-4d0d38b3.js";import{L as z,M as S,a as P,A as Z}from"./dispatch-live-error-6bb10a68.js";import{U as O}from"./unified-query-transformer-480aab9f.js";import{V,h as G,m as R,M as W}from"./audio-09dfdd64.js";let Y=class extends t{constructor(){super(...arguments),this.controls=!1,this._refVideo=r(),this._mediaPlayerController=new V(this,(()=>this._refVideo.value??null),(()=>this.controls))}async getMediaPlayerController(){return this._mediaPlayerController}render(){return s`
      <video
        ${o(this._refVideo)}
        muted
        playsinline
        ...
        @loadedmetadata=${e=>{e.target&&this.controls&&G(e.target,W)}}
    ...
    `}updated(e){super.updated(e);(!!this._refCarousel.value&&this._mediaActionsController.setRoot(this._refCarousel.value)||e.has("viewManagerEpoch"))&&this._setMediaTarget(),e.has("viewManagerEpoch")&&this.viewManagerEpoch?.manager.getView()?.context?.mediaViewer!==this.viewManagerEpoch?.oldView?.context?.mediaViewer&&this._seekHandler()}_setMediaTarget(){this._media?.length&&null!==this._selected?(this._mediaActionsController.setTarget(this._selected,!this.viewFilterCameraID||this.viewManagerEpoch?.manager.getView()?.camera===this.viewFilterCameraID),this._mediaHeightController.setSelected(this._selected)):this._mediaActionsController.unsetTarget()}async _seekHandler(){if(!this.hass||!this._media||!this._loadedMediaPlayerController||null===this._selected)return;const e=this._media[this._selected];if(!e)return;const a=this.viewManagerEpoch?.manager.getView(),i=a?.context?.mediaViewer?.seek??e.getStartTime();if(!i)return;const t=e.includesTime(i);T(this,!t,"unseekable"),t||this._loadedMediaPlayerController.isPaused()?t&&this._loadedMediaPlayerController.isPaused()&&this._loadedMediaPlayerController.play():this._loadedMediaPlayerController.pause();const r=await(this.cameraManager?.getMediaSeekTime(e,i))??null;null!==r&&this._loadedMediaPlayerController.seek(r)}_renderMediaItem(e){const a=this.viewManagerEpoch?.manager.getView();return this.hass&&a&&this.viewerConfig?s` <div class="embla__slide">
      ...
      ></advanced-camera-card-viewer-provider>
    </div>`:null}static get styles(){return g(":host {\n  display: block;\n  --video-max-height: none;\n  transition: max-height 0.1s ease-in-out;\n  position: relative;\n  border-radius: var(--advanced-camera-card-border-radius-final);\n  overflow: hidden;\n}\n\n:host(:not([grid-id])) {\n  height: 100%;\n}\n\n:host([unselected]) advanced-camera-card-carousel,\n:host([unselected]) .seek-warning {\n  pointer-events: none;\n}\n\n:host([unseekable]) advanced-camera-card-carousel {\n  filter: brightness(50%);\n}\n\n:host([unseekable]) .seek-warning {\n  display: block;\n}\n\n.seek-warning {\n  display: none;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translateX(-50%) translateY(-50%);\n  color: white;\n}\n\n.embla__slide {\n  display: flex;\n  height: 100%;\n  width: 100%;\n  flex: 0 0 100%;\n}")}};e([a({attribute:!1})],U.prototype,"hass",void 0),e([a({attribute:!1})],U.prototype,"viewManagerEpoch",void 0),e([a({attribute:!1})],U.prototype,"viewFilterCameraID",void 0),e([a({attribute:!1,hasChanged:A})],U.prototype,"viewerConfig",void 0),e([a({attribute:!1})],U.prototype,"resolvedMediaCache",void 0),e([a({attribute:!1})],U.prototype,"cardWideConfig",void 0),e([a({attribute:!1})],U.prototype,"cameraManager",void 0),e([a({attribute:!1})],U.prototype,"showControls",void 0),e([m()],U.prototype,"_selected",void 0),U=e([i("advanced-camera-card-viewer-carousel")],U);let F=class extends t{_renderCarousel(e){const a=this.viewManagerEpoch?.manager.getView()?.camera,i=e?this.cameraManager?.getStore().getCameraConfig(e)?.dimensions?.grid?.width_factor:void 0;return s`
    ...
    `:this._renderCarousel()}static get styles(){return g(L)}};e([a({attribute:!1})],F.prototype,"hass",void 0),e([a({attribute:!1})],F.prototype,"viewManagerEpoch",void 0),e([a({attribute:!1})],F.prototype,"viewerConfig",void 0),e([a({attribute:!1})],F.prototype,"resolvedMediaCache",void 0),e([a({attribute:!1})],F.prototype,"cardWideConfig",void 0),e([a({attribute:!1})],F.prototype,"cameraManager",void 0),e([a({attribute:!1})],F.prototype,"viewItemManager",void 0),F=e([i("advanced-camera-card-viewer-grid")],F);let H=class extends t{constructor(){super(...arguments),this.isEmpty=!1}willUpdate(e){if(e.has("viewManagerEpoch")){const e=this.viewManagerEpoch?.manager.getView();this.isEmpty=!e?.queryResults?.getResults()?.filter((e=>u.isMedia(e))).length}}render(){if(this.hass&&this.viewManagerEpoch&&this.viewerConfig&&this.cameraManager&&this.cardWideConfig){if(this.isEmpty){const e=!!this.viewManagerEpoch.manager.getView()?.context?.loading?.query;return E({type:"info",message:k(e?"error.awaiting_media":"common.no_media"),icon:"mdi:multimedia",dotdotdot:e})}return s` <advanced-camera-card-viewer-grid
      .hass=${this.hass}
      .viewManagerEpoch=${this.viewManagerEpoch}
      .viewerConfig=${this.viewerConfig}
      .resolvedMediaCache=${this.resolvedMediaCache}
      ...
      .viewItemManager=${this.viewItemManager}
    >
    </advanced-camera-card-viewer-grid>`}}static get styles(){return g(":host {\n  width: 100%;\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n  gap: 5px;\n}\n\n:host([empty]) {\n  aspect-ratio: 16/9;\n}\n\nadvanced-camera-card-viewer-carousel {\n  flex: 1;\n  min-height: 0;\n}")}};e([a({attribute:!1})],H.prototype,"hass",void 0),e([a({attribute:!1})],H.prototype,"viewManagerEpoch",void 0),e([a({attribute:!1})],H.prototype,"viewerConfig",void 0),e([a({attribute:!1})],H.prototype,"resolvedMediaCache",void 0),e([a({attribute:!1})],H.prototype,"cameraManager",void 0),e([a({attribute:!1})],H.prototype,"cardWideConfig",void 0),e([a({attribute:!1})],H.prototype,"viewItemManager",void 0),e([a({attribute:"empty",reflect:!0,type:Boolean})],H.prototype,"isEmpty",void 0),H=e([i("advanced-camera-card-viewer")],H);export{H as AdvancedCameraCardViewer};
